package learn.lhb.security.spring.boot.security.service;

import learn.lhb.security.spring.boot.security.dao.UserDao;
...
//        return userDetails;
    ...
    public String[] getPermissionStringArray(String userId)  {
        ...
        // 根据用户的id 查询用户的权限
        List<String> permissions = userDao.findPermissionByUserId(userId);
